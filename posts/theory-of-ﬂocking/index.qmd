...
where the probability current is $\vec J=-\alpha\vec M p-\frac{1}{2N}\nabla\left[G(r)p\right]$. At the stationary state, assuming zero probability flux, i.e. $\vec J=0$, because the system is rotationally symmetric,
