...
![The Cauchy network activity exhibits a continuous phase transition while tuning the parameter g, whereas the Gaussian network exhibits an abrupt phase transition. (Łukasz Kusmierz, Shun Ogawa, and Taro Toyoizumi. Phys. Rev. Lett. 2020.)](prl.png)
